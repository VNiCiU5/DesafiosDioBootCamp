...
//	
		...
		public static void main(String[] args) {
			...
			System.out.println("digite o numero que achas o correto: \n");
			...
			System.out.println(Arrays.toString(respostasCompetidoresSplit));
			
	
			if (t.equals(respostasCompetidores) == true ) {
		        count++;
			}
		        	
			System.out.println("numero de elementos iguais: " + count);
		 }
			
			System.out.println("numero final de elementos iguais: " + count);
