package br.com.vin.DesafiosDeCodigo;
import java.util.HashSet;
import java.util.Scanner;
import java.util.Set;

public class numeroDeFigurinhas {
...
//	Seu programa deve produzir uma única linha contendo um inteiro representando o número de figurinhas que falta para completar o álbum.
	...
	public static void main(String[] args) {
		...
		System.out.println("digite o numero total de figurinhas do album: \n");
		
		int numTotal = scan.nextInt();
		
		System.out.println("digite o numero de figurinhas compradas: \n");
		...
		for (int i = 0 ; i < numFigCompradas; i++) {
			...
			System.out.println("qual figurinha voce retirou?\n  ");
			
			int figurinhaRetirada = scan.nextInt();
			
			System.out.println("parabens, voce retirou:\n " + figurinhaRetirada);
			
			setFig.add(figurinhaRetirada);
